...
/*
gRPC TODO: 1. Call dao API to list comment and check if any error happen. If so, return an nil response.
...
/*
gRPC TODO: 1. Send gRPC to video server to check if the video id in request is valid. Think about which gRPC provided by video server to use?
...
/*
gRPC TODO: 1. Update a comment with information in request.
...
/*
gRPC TODO: 1. Call dao API to delete a comment and do error handling. You need to handle comment not found error and other unknown error here.
